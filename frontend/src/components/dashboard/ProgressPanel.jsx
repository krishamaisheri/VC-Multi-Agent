...
function ProgressPanel({ token }) {
  ...
  return (
    <div>
      <p className="text-xs font-mono uppercase tracking-widest text-coral mb-2">03 · Progress</p>
      <h1 className="font-display text-3xl text-ink mb-8">Across Every Session</h1>
      ...
      {report?.status === 'error' && <p className="text-sm text-maroon">{report.message}</p>}
      ...
      {report?.status === 'ok' && (
        <div className="space-y-12">
          ...
          <div className="space-y-5">
            <h2 className="font-display text-xl text-ink">What's Improved</h2>
          ...
          <div className="space-y-5">
            <h2 className="font-display text-xl text-ink">Did You Act On Past Feedback?</h2>
          ...
          <div className="space-y-5">
            <h2 className="font-display text-xl text-ink">Consistent Weaknesses</h2>
          ...
          {report.consistent_strengths?.length > 0 && (
            <div className="space-y-5">
              <h2 className="font-display text-xl text-ink">Consistent Strengths</h2>
              <div className="space-y-3">
